...
export default () => (
    function () {
      (window.Karen = {}), (window.Karen._util = {});
    }.call(window),
    (window.Karen._util.domReady = function (t) {
      var e = !1,
        n = function () {
    ...
    (window.Karen._util.assign = function (t) {
      "use strict";
      if (null == t)
    ...
    function () {
      (window.Karen._url = {}),
        (window.Karen._url.extractQueryStringParams = function (t) {
        ...
        (window.Karen._url.stripQuery = function (t) {
          return t.split("?")[0];
        });
    }.call(window),
    function () {
      (window.Karen._util.snakeCaseKeys = function (t) {
        var e, n, o;
        o = {};
        for (n in t)
          (e = n
        ...
        (window.Karen._util.pick = function (t, e) {
          var n, o, i, r;
          if (t) {
    ...
    function () {
      var t, e, n, o, i;
      (window.Karen._autoLoadInlineWidgets = function () {
        return window.Karen._util.domReady(function () {
          return e();
        });
      }),
        (window.Karen.initBadgeWidget = function (e) {
          return window.Karen._util.domReady(function () {
            return t(e);
          });
        }),
        (window.Karen.destroyBadgeWidget = function () {
          return window.Karen.badgeWidget
            ? (window.Karen.badgeWidget.destroy(),
              delete window.Karen.badgeWidget)
            : void 0;
        }),
        (window.Karen.initPopupWidget = function (t) {
          return window.Karen._util.domReady(function () {
            return window.Karen.showPopupWidget(t.url, "PopupText", t);
          });
        }),
        (window.Karen.initInlineWidget = function (t) {
          return t.url
            ? (t.parentElement || (t.parentElement = o()),
              window.Karen._util.domReady(function () {
                return (t.embedType = "Inline"), new window.Karen.Iframe(t);
              }))
            : void 0;
        }),
        (window.Karen.showPopupWidget = function (t, e, n) {
          var o;
          return (
            null == e && (e = "PopupText"),
            null == n && (n = {}),
            ...
            (o = function () {
              return delete window.Karen.popupWidget;
            }),
            (window.Karen.popupWidget = new window.Karen.PopupWidget(
              t,
              o,
              e,
              n
            )),
            window.Karen.popupWidget.show()
          );
        }),
        (window.Karen.closePopupWidget = function () {
          return window.Karen.popupWidget
            ? window.Karen.popupWidget.close()
            : void 0;
        }),
        (o = function () {
          var t;
        ...
        (e = function () {
          var t, e, n, o, r;
          for (
            e = document.querySelectorAll(".karen-inline-widget"),
              r = [],
              n = 0,
              o = e.length;
            o > n;
        ...
        (t = function (t) {
          ...
          return (
            ...
            (e = n(t)),
            (i = function () {
              return window.Karen.showPopupWidget(t.url, "PopupWidget", t);
            }),
            (o = window.Karen._util.assign({ onClick: i }, e)),
            (window.Karen.badgeWidget = new window.Karen.BadgeWidget(o))
          );
        }),
        (n = function (t) {
          var e, n;
      ...
      window.Karen.Iframe = (function () {
        ...
        return (
          ...
          (t.prototype.parseOptions = function () {
            ...
            if (
              ((t = { inlineStyles: !1 }),
              (this.options = window.Karen._util.assign({}, t, this.options)),
              (this.parent = this.options.parentElement),
              !this.parent)
            )
              throw "Karen: Parent element not set";
            if (
              ...
              throw "Karen: Widget URL not set";
          }),
          ...
          (t.prototype.getSource = function () {
            ...
            return (
              (t =
                window.Karen._url.stripQuery(this.url) +
                "?" +
                this.getParams()),
          ...
          (t.prototype.getUtmParamsFromHost = function () {
            ...
            return (
              ...
              (e = window.Karen._url.extractQueryStringParams(
                window.location.href
              )),
              window.Karen._util.pick(e, t)
            );
          }),
          (t.prototype.getParamsFromUrl = function () {
            return window.Karen._url.extractQueryStringParams(this.url);
          }),
          (t.prototype.getParamsFromOptions = function () {
            return window.Karen._util.assign(
              {},
          ...
          (t.prototype.getUtmParams = function () {
            ...
            return this.options.utm
              ? ((t = [
                ...
                window.Karen._util.snakeCaseKeys(
                  window.Karen._util.pick(this.options.utm, t)
                ))
              : null;
          }),
          (t.prototype.getPrefillParams = function () {
            ...
            if (
              ...
              (n = window.Karen._util.snakeCaseKeys(
                window.Karen._util.pick(this.options.prefill, e)
              )),
          ...
          (t.prototype.formatMobile = function () {
            return this.inlineStyles
              ...
              : (this.parent.className += " karen-mobile");
          }),
          (t.prototype.buildSpinner = function () {
            var t;
            return (
              (t = document.createElement("div")),
              (t.className = "karen-spinner"),
    ...
    function () {
      ...
      window.Karen.PopupWidget = (function () {
        function e(e, n, o, i) {
          (this.url = e),
            (this.onClose = n),
            (this.embedType = o),
        ...
        return (
          ...
          (e.prototype.buildOverlay = function () {
            return (
              ...
              (this.overlay.className = "karen-overlay"),
          ...
          (e.prototype.buildCloseOverlay = function () {
            ...
            return (
              (t = document.createElement("div")),
              (t.className = "karen-close-overlay"),
          ...
          (e.prototype.lockPageScroll = function () {
            return (
              window.bodyScrollLock.disableBodyScroll(this.overlay),
          ...
          (e.prototype.unlockPageScroll = function () {
            return (
              window.bodyScrollLock.enableBodyScroll(this.overlay),
              document.removeEventListener(
                "touchmove",
    ...
    function () {
      window.Karen.BadgeWidget = (function () {
        function t(t) {
        ...
        return (
          ...
          (t.prototype.buildWidget = function () {
            return (
              ...
              (this.widget.className = "karen-badge-widget"),
          ...
          (t.prototype.buildContent = function () {
            ...
            return (
              (t = document.createElement("div")),
              (t.className = "karen-badge-content"),
              "#ffffff" === this.options.color &&
                (t.className += " karen-white"),
    ...
    window.Karen._autoLoadInlineWidgets()
  );
